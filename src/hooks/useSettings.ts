...
نحن في وان اير للتكييف نولي اهتماماً كبيراً لخصوصية بيانات عملائنا.
1. المعلومات التي نجمعها: نجمع المعلومات التي تقدمها لنا عند الطلب (الاسم، العنوان، رقم الهاتف) لتنفيذ طلبك وتوصيله.
2. استخدام المعلومات: نستخدم بياناتك فقط لمعالجة الطلبات والتواصل معك بخصوص حالة الطلب.
3. مشاركة البيانات: لا نشارك بياناتك مع أي أطراف ثالثة إلا لغرض التوصيل أو الصيانة عند الضرورة.
4. حقوقك: يحق لك طلب تعديل أو حذف بياناتك المسجلة لدينا في أي وقت.`,
    terms_and_conditions: `الشروط والأحكام
1. المنتجات والأسعار: جميع المنتجات تخضع للتوفر. الأسعار بالجنيه المصري وتشمل الضريبة.
2. الطلب والدفع: الدفع متاح عند الاستلام أو بالطرق الإلكترونية.
3. التوصيل والتركيب: يتم التنسيق للموعيد حسب المنطقة.
4. الضمان: ضمان 5 سنوات من الوكيل الرسمي (ميراكو كاريير / ميديا) يسري من تاريخ التركيب.
5. الاسترجاع: تطبق سياسة حماية المستهلك (14 يوم) للمنتجات غير المستخدمة في حالتها الأصلية.`,
