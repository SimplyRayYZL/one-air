...
const Compare = () => {
  ...
  return (
    <>
      <Helmet>
        <title>مقارنة المنتجات | وان اير للتكييف</title>
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-grow py-8 bg-background">
          <div className="container mx-auto px-4">
            ...
            {items.length === 0 ? (
              <div className="text-center py-16 card-oneair">
                ...
                <Link to="/products">
                  <Button className="btn-oneair-primary">
                    تصفح المنتجات
                  </Button>
                </Link>
              </div>
                    ...
                    {specifications.map((spec) => (
                      <tr key={spec.key} className="border-b">
                        ...
                        {items.map((product) => (
                          <td key={product.id} className="p-4 text-center">
                            {spec.key === "rating" ? (
                              <span className="text-oneair-gold font-bold">
                    ...
                    <tr>
                      ...
                      {items.map((product, index) => (
                        <td key={product.id} className={`p-4 ${index === items.length - 1 ? 'rounded-bl-xl' : ''}`}>
                          <Button
                            className="w-full btn-oneair-primary"
