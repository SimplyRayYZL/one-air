                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
                    {steps.map((step, index) => (
                        <div
                            ...
                            className={`group relative bg-card rounded-2xl p-6 md:p-8 border-t-4 ${step.borderColor} shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2`}
                        >
                            {/* Step Number Badge */}
                            <div className="absolute -top-4 right-6 bg-gradient-to-r from-muted to-background px-3 py-1 rounded-full">
                            ...
                            {index < steps.length - 1 && (
                                <div className="hidden lg:block absolute top-1/2 -left-4 w-8 h-0.5 bg-gradient-to-r from-border to-transparent" />
                            )}
                        </div>
                    ))}
                </div>
