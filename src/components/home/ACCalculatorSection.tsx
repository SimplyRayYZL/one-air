...
const ACCalculatorSection = ({ title, subtitle }: { title?: string, subtitle?: string }) => {
    ...
    return (
        <section className="relative w-full min-h-[400px] flex items-center justify-center overflow-hidden py-12 lg:py-0">
            {/* Dynamic Background */}
            <div className="absolute inset-0 z-0 bg-secondary/10">
                {banner?.image_url ? (
                    ...
                    <div className="w-full h-full bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-blue-900 via-slate-900 to-black" />
                )}
            </div>
